...
```xml
<dependency>
  <groupId>io.pesamoni</groupId>
  <artifactId>pesamoni-java-client</artifactId>
...
```groovy
compile "io.pesamoni:pesamoni-java-client:1.0.0"
```
...
* `target/pesamoni-java-client-1.0.0.jar`
* `target/lib/*.jar`
...
The Java Api library is available as open source under the terms of the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
